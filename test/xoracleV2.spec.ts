...
const ADDRESS_INTERFACE = {
  mainnet: {
    core: {
      ...
      oracles: {
        xOracle:
          '0x9b3e0eb6c4db4470d71468c57db22ff606f7aacbe895c7684a576a7b8802c8ed',
        xOracleCap:
          '0x6775f4beb3c323ee2eb5dca7906dc97df39e67ce52873cc06fc8a35b84697b3b',
        supra: {
          registry:
            '0x6196bf9bdf0b09de79ae8a2dcd60d1635c7817a872c84bb15374a595fbc2803e',
          registryCap:
            '0x0e924ece4f8c9e9f1346fa92010c27d0762e39e9ab748db5de49cc6864a38cb2',
          holder:
        ...
        pyth: {
          registry:
            '0x721b2aac3e66e0647c509ccf53ae58a5cb6c5666e21a227bb8247cb401ba142f',
          registryCap:
            '0x4d4aeb68dc5ae30d6383d63cd0c4e7a9789b78eee1901d8ce1079dd93d1abf79',
          state:
      ...
      packages: {
        ...
        supra: {
          id: '0xa0e9549b50bcb11d22b251593f5409cb51dad06af8599e7ba4732876292592bc',
          upgradeCap: '',
        },
        pyth: {
          id: '0x7c283d1c14bbfd94e6ed7222265e49bda0be17f2bcea9f3aeea7f6ada5648292',
          upgradeCap:
        ...
        xOracle: {
          id: '0xe11209515f632fbc9280b09dcc25869f1efa02a675a96b92497857562f9a8a8f',
          upgradeCap:
  ...
  memo: 'test package for oracle v2',
  createdAt: 'Tue Aug 13 2024 09:03:26 GMT+0000 (Coordinated Universal Time)',
  updatedAt: 'Tue Aug 13 2024 09:03:26 GMT+0000 (Coordinated Universal Time)',
  version: 0,
  id: '66bc988f312deae5d529ffdb',
};
...
describe('Test XOracle V2', async () => {
  ...
  it('Should updates oracles success', async () => {
    const coins = ['weth', 'wusdc', 'wusdt', 'sui'] as SupportAssetCoins[];
