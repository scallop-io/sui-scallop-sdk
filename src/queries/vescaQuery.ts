...
export const getVescaKeys = async (
  ...
  const veScaObjId = utils.constants.get('vesca.object');
...
export const getVeSca = async (
  ...
  const tableId = utils.constants.get(`vesca.tableId`);
...
const getTotalVeScaTreasuryAmount = async (
  ...
  const veScaPkgId = utils.constants.get('vesca.id');
  const veScaConfig = utils.constants.get('vesca.config');
  veScaTreasury = veScaTreasury ?? utils.constants.get('vesca.treasury');
...
export const getVeScaTreasuryInfo = async (
  ...
  const veScaTreasuryId = utils.constants.get('vesca.treasury');
  const veScaTreasury =
