...
/** Minimal context for resolving the obligation bound to a veSca key. */
export type BindedObligationContext = BaseContext & {
  metadata: {
    addresses: ObligationAddresses<
      'borrowIncentiveObject' | 'incentivePools' | 'veScaObject'
    >;
  };
};
