...
export type BorrowIncentiveAddressConfig = Pick<
  AddressesInterface['borrowIncentive'],
  'query' | 'incentivePools' | 'incentiveAccounts'
>;
...
export type BorrowIncentiveRepoContext = BaseContext & {
  addresses: BorrowIncentiveAddressConfig;
