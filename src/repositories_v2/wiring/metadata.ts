 ...
 * the pure repositories_v2 layer. Each `buildXMetadata` is a pure function that
...
export const buildObligationMetadata = (
  ...
  addresses: {
    ...
    market: utils.address.get('core.market'),
    borrowIncentiveObject: utils.address.get('borrowIncentive.object'),
    incentivePools: utils.address.get('borrowIncentive.incentivePools'),
    veScaObject: utils.address.get('vesca.object'),
  },
});
...
export const buildBorrowIncentiveAddresses = (
  utils: ScallopUtils
): BorrowIncentiveAddressConfig => ({
  query: utils.address.get('borrowIncentive.query'),
  incentivePools: utils.address.get('borrowIncentive.incentivePools'),
  incentiveAccounts: utils.address.get('borrowIncentive.incentiveAccounts'),
});
